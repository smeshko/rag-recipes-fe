    ...
    <div data-testid="recipe-new-page">
      ...
      <Bloom duration={0.7} delay={0.08} className="pt-2 pb-2">
        ...
        <h1 className="mt-5 font-display text-[clamp(30px,4vw,40px)] font-medium">
          Write one <em className="text-accent italic">down.</em>
        </h1>
        {create.isError && (
          <p
            data-testid="create-failed"
            role="alert"
            className="mt-4 rounded-[14px] border border-danger-border bg-danger-fill px-5 py-3 text-[13px] font-semibold text-danger"
          >
        ...
        <p className="mt-4 rounded-[14px] border border-border bg-accent-fill px-5 py-3 text-[13px] text-fg-muted">
