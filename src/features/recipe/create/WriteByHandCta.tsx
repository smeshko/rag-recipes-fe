...
export function WriteByHandCta() {
  ...
  return (
    <Panel className="flex flex-wrap items-center justify-between gap-x-6 gap-y-3">
      <div>
        <b className="block text-[18px] font-semibold tracking-[-0.01em]">
          Or write one down
        </b>
        <small className="mt-[3px] block text-[15px] text-fg-muted">
      ...
      <Link
        ...
        className="inline-flex items-center rounded-pill bg-surface-inverted px-5 py-2 text-[13px] font-medium text-fg-inverted transition-opacity hover:opacity-80 pointer-coarse:min-h-11"
      >
        Add a recipe
      </Link>
    </Panel>
