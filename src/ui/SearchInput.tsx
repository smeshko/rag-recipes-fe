/* Controlled pill field — epic 02 phase 2.1 owns this extension of the 1.3
   primitive: the screen needs the live value for URL writes and the AI answers
   strip, and controlled props make Back/Forward resync the caller's problem
...
export function SearchInput({
  ...
  return (
    ...
    >
      {/* Decorative: the placeholder and the Search button carry the meaning, so
      ...
      {/* Plain submit. The LLM actions (Ask the shelf, Compose a menu) live in
          the AI answers strip under the bar, not in the field: Enter and this
