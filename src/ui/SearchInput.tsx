  ...
  return (
    ...
    >
      ...
      <button
        ...
        /* accent-strong, not accent: white on light `accent` #C96F3B measures
           3.61:1 — the one light contrast failure phase 5.6's criteria name.
           #B25E2E is 4.63:1, hovering to `accent-pressed` #9A4F26 at 5.97:1.
           Theme-agnostic on purpose (no `dark:` arm): in dark the same pair is
           #F5B481 at 10.05:1 hovering to #D8863F at 6.35:1, which is also the
           right rest→hover direction for a dark solid. Plan D12. */
